  ...
  if (closedData.length === 0) {
    container.innerHTML = `
      <div class="col-span-full text-center py-12">
        ...
        <h3 class="text-xl font-bold text-gray-600 mb-2">لا توجد بلاغات مغلقة</h3>
        <p class="text-gray-500">لم يتم إغلاق أي بلاغات بعد</p>
      </div>
    `;
    return;
  }
    ...
    return `
      <div class="bg-white rounded-xl p-6 shadow-lg border border-green-100 hover:shadow-xl transition-shadow">
        ...
        <div class="space-y-2 mb-4">
          ...
          <div class="flex justify-between">
            <span class="text-gray-500 text-sm">تاريخ الإغلاق:</span>
    ...
    <div class="bg-white rounded-xl p-6 shadow-lg border border-green-100">
      <div class="flex items-center gap-3 mb-4">
        ...
        <div>
          ...
          <p class="text-sm text-gray-600">${hospital.reports.length} بلاغ مغلق</p>
        </div>
      </div>
